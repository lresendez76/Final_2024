...
Based on the graphs, the group of males who contracted COVID and the ones who received the vaccine had less symptoms than those that received the placebo, while the all male group that didn't contract COVID showed no difference between those who were vaccinated and unvaccinated. 
...
Based off this information the vaccine shows a significant reduction in the infection rate compared to the placebo:
Infection Rate (COVID-19): 1.02% (Vaccine) vs. 2.82% (Placebo).

The vaccine maintains a higher proportion of healthy individuals (OK) compared to the placebo:
OK Rate: 98.98% (Vaccine) vs. 97.18% (Placebo).
The proportion of individuals with COVID-19 is much higher in the placebo group (73.80%) compared to the vaccine group (26.20%).

The proportion of OK individuals is roughly equal between the two groups, with a slight edge for the vaccine group (49.99% for Vaccine vs. 50.01% for Placebo).

In conclusion, the vaccine demonstrates a significant improvement in reducing COVID-19 infection rates and a slight improvement in maintaining a higher proportion of healthy individuals compared to the placebo.
...
There is overwhelming evidence to reject the null hypothesis of no association between the treatment (placebo or vaccine) and the infection status (COVID-19 infected or OK).

Both Pearson's Chi-squared test and Fisher's Exact Test demonstrate that the vaccine is significantly associated with a lower risk of COVID-19 infection compared to the placebo.

The odds of COVID-19 infection are approximately 2.82 times higher in the placebo group compared to the vaccine group.

These findings strongly support the effectiveness of the vaccine in reducing the risk of COVID-19 infection.
...
```{r}
femaleData = filter (FinalData,sex == "M")
```
...
Based on the graphs, they are showing that from the all female group who contracted COVID, the ones who received the vaccine had less symptoms than those with the placebo while the all the female group that did not contract COVID showed no difference between those who were vaccinated and not vaccinated. 
...
Based off this information the placebo group has a higher proportion of infected individuals (73.80%) compared to the vaccine group (26.20%).
Within the placebo group, 2.82% of individuals are infected, whereas within the vaccine group, only 1.02% are infected.

Proportion of OK:
The placebo and vaccine groups have similar proportions of OK individuals (50.01% and 49.99% respectively).
Within the placebo group, 97.18% of individuals are OK, while within the vaccine group, 98.98% are OK.

Concluding the vaccine group has a significantly lower proportion of COVID-19 infected individuals compared to the placebo group.
The vaccine is more effective in reducing the infection rate within its group (1.02%) compared to the placebo group (2.82%).

Both treatments result in high proportions of OK individuals, with the vaccine showing a slight edge (98.98% vs. 97.18%).
...
There is overwhelming evidence to reject the null hypothesis of no association between the treatment (placebo or vaccine) and the infection status (COVID-19 infected or OK).
Both Pearson's Chi-squared test and Fisher's Exact Test demonstrate that the vaccine is significantly associated with a lower risk of COVID-19 infection compared to the placebo.
The odds of COVID-19 infection are approximately 2.26 times higher in the placebo group compared to the vaccine group.
These findings strongly support the effectiveness of the vaccine in reducing the risk of COVID-19 infection.
